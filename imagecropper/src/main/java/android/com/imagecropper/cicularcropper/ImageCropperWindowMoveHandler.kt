...
internal class ImageCropperWindowMoveHandler(private val mType: Type,
                                             imageCropperCropWindowHandler: ImageCropperCropWindowHandler,
                                             touchX: Float,
                                             touchY: Float) {
    private val mMinCropWidth: Float = imageCropperCropWindowHandler.minCropWidth
    private val mMinCropHeight: Float = imageCropperCropWindowHandler.minCropHeight
    private val mMaxCropWidth: Float = imageCropperCropWindowHandler.maxCropWidth
    private val mMaxCropHeight: Float = imageCropperCropWindowHandler.maxCropHeight
    private val mTouchOffset = PointF()

    init {
        calculateTouchOffset(imageCropperCropWindowHandler.rect, touchX, touchY)
    }
     ...
     */
    fun move(rect: RectF, x: Float, y: Float, bounds: RectF, viewWidth: Int, viewHeight: Int, snapMargin: Float, fixedAspectRatio: Boolean, aspectRatio: Float) {
    ...
    private fun calculateTouchOffset(rect: RectF, touchX: Float, touchY: Float) {
        ...
        when (mType) {
            ImageCropperWindowMoveHandler.Type.TOP_LEFT -> {
                touchOffsetX = rect.left - touchX
                touchOffsetY = rect.top - touchY
            }
            ImageCropperWindowMoveHandler.Type.TOP_RIGHT -> {
                touchOffsetX = rect.right - touchX
                touchOffsetY = rect.top - touchY
            }
            ImageCropperWindowMoveHandler.Type.BOTTOM_LEFT -> {
                touchOffsetX = rect.left - touchX
                touchOffsetY = rect.bottom - touchY
            }
            ImageCropperWindowMoveHandler.Type.BOTTOM_RIGHT -> {
                touchOffsetX = rect.right - touchX
                touchOffsetY = rect.bottom - touchY
            }
            ImageCropperWindowMoveHandler.Type.LEFT -> {
                touchOffsetX = rect.left - touchX
                touchOffsetY = 0f
            }
            ImageCropperWindowMoveHandler.Type.TOP -> {
                touchOffsetX = 0f
                touchOffsetY = rect.top - touchY
            }
            ImageCropperWindowMoveHandler.Type.RIGHT -> {
                touchOffsetX = rect.right - touchX
                touchOffsetY = 0f
            }
            ImageCropperWindowMoveHandler.Type.BOTTOM -> {
                touchOffsetX = 0f
                touchOffsetY = rect.bottom - touchY
            }
            ImageCropperWindowMoveHandler.Type.CENTER -> {
     ...
     */
    private fun moveCenter(rect: RectF, x: Float, y: Float, bounds: RectF, viewWidth: Int, viewHeight: Int, snapRadius: Float) {
     ...
     */
    private fun moveSizeWithFreeAspectRatio(rect: RectF, x: Float, y: Float, bounds: RectF, viewWidth: Int, viewHeight: Int, snapMargin: Float) {
        when (mType) {
            ImageCropperWindowMoveHandler.Type.TOP_LEFT -> {
            ...
            ImageCropperWindowMoveHandler.Type.LEFT -> adjustLeft(rect, x, bounds, snapMargin, 0f, false, false)
            ImageCropperWindowMoveHandler.Type.TOP -> adjustTop(rect, y, bounds, snapMargin, 0f, false, false)
            ImageCropperWindowMoveHandler.Type.RIGHT -> adjustRight(rect, x, bounds, viewWidth, snapMargin, 0f, false, false)
            ImageCropperWindowMoveHandler.Type.BOTTOM -> adjustBottom(rect, y, bounds, viewHeight, snapMargin, 0f, false, false)
            else -> {
            }
        }
    }
     ...
     * given aspect ratio.
     */
    private fun moveSizeWithFixedAspectRatio(rect: RectF, x: Float, y: Float, bounds: RectF, viewWidth: Int, viewHeight: Int, snapMargin: Float, aspectRatio: Float) {
        when (mType) {
            ImageCropperWindowMoveHandler.Type.TOP_LEFT -> if (calculateAspectRatio(x, y, rect.right, rect.bottom) < aspectRatio) {
            ...
            ImageCropperWindowMoveHandler.Type.TOP_RIGHT -> if (calculateAspectRatio(rect.left, y, x, rect.bottom) < aspectRatio) {
            ...
            ImageCropperWindowMoveHandler.Type.BOTTOM_LEFT -> if (calculateAspectRatio(x, rect.top, rect.right, y) < aspectRatio) {
            ...
            ImageCropperWindowMoveHandler.Type.BOTTOM_RIGHT -> if (calculateAspectRatio(rect.left, rect.top, x, y) < aspectRatio) {
     ...
     */
    private fun adjustLeft(rect: RectF, left: Float, bounds: RectF, snapMargin: Float, aspectRatio: Float, topMoves: Boolean, bottomMoves: Boolean) {
     ...
     * @param snapMargin the snap distance to the image edge (in pixels)
     */
    private fun adjustRight(rect: RectF, right: Float, bounds: RectF, viewWidth: Int, snapMargin: Float, aspectRatio: Float, topMoves: Boolean, bottomMoves: Boolean) {
     ...
     * @param snapMargin the snap distance to the image edge (in pixels)
     */
    private fun adjustTop(rect: RectF, top: Float, bounds: RectF, snapMargin: Float, aspectRatio: Float, leftMoves: Boolean, rightMoves: Boolean) {
     ...
     * @param snapMargin the snap distance to the image edge (in pixels)
     */
    private fun adjustBottom(rect: RectF, bottom: Float, bounds: RectF, viewHeight: Int, snapMargin: Float, aspectRatio: Float, leftMoves: Boolean, rightMoves: Boolean) {
