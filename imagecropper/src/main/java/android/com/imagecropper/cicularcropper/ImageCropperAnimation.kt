 ...
 */
internal class ImageCropperAnimation
//endregion

(
        //region: Fields and Consts

        private val mImageView: ImageView, private val mImageCropperOverlayView: ImageCropperOverlayView) : Animation(), Animation.AnimationListener {
    ...
    fun setStartState(boundPoints: FloatArray, imageMatrix: Matrix) {
        ...
        mStartCropWindowRect.set(mImageCropperOverlayView.cropWindowRect)
    ...
    fun setEndState(boundPoints: FloatArray, imageMatrix: Matrix) {
        ...
        mEndCropWindowRect.set(mImageCropperOverlayView.cropWindowRect)
    ...
    override fun applyTransformation(interpolatedTime: Float, t: Transformation) {
        ...
        mImageCropperOverlayView.cropWindowRect = mAnimRect

        for (i in mAnimPoints.indices) {
            mAnimPoints[i] = mStartBoundPoints[i] + (mEndBoundPoints[i] - mStartBoundPoints[i]) * interpolatedTime
        }
        mImageCropperOverlayView.setBounds(mAnimPoints, mImageView.width, mImageView.height)
