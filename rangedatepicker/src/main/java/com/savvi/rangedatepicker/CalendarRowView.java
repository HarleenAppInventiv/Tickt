...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    public void setTypeface(Typeface typeface) {
        for (int i = 0; i < getChildCount(); i++) {
            if (getChildAt(i) instanceof CalendarCellView) {
                if (((CalendarCellView) getChildAt(i)).isToday()) {
                    ((CalendarCellView) getChildAt(i)).getDayOfMonthTextView().setTypeface(ResourcesCompat.getFont(getContext(), R.font.neue_haas_display_medium));
                } else {
