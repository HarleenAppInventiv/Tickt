        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    if (cell.getRangeState() != null && cell.getRangeState().name().equals("FIRST")) {
                        cellView.getDayOfMonthTextView().setTextColor(Color.BLACK);
                        cellView.getDayOfMonthTextView().setTypeface(ResourcesCompat.getFont(getContext(), R.font.neue_haas_display_medium));
                    } else if (cell.getRangeState() != null && cell.getRangeState().name().equals("LAST")) {
                        cellView.getDayOfMonthTextView().setTextColor(Color.BLACK);
                        cellView.getDayOfMonthTextView().setTypeface(ResourcesCompat.getFont(getContext(), R.font.neue_haas_display_medium));
                    } else if (cell.getRangeState() != null && cell.getRangeState().name().equals("NONE") && cell.isSelected()) {
                        cellView.getDayOfMonthTextView().setTextColor(Color.BLACK);
                        cellView.getDayOfMonthTextView().setTypeface(ResourcesCompat.getFont(getContext(), R.font.neue_haas_display_medium));
                    } else {
                        cellView.getDayOfMonthTextView().setTypeface(ResourcesCompat.getFont(getContext(), R.font.neue_haas_display_roman));
                        if (cell.isToday()) {
                            cellView.getDayOfMonthTextView().setTextColor(Color.parseColor("#AEAEAE"));
                        } else if (cell.isCurrentMonth() && cell.isSelectable()) {
                            cellView.getDayOfMonthTextView().setTextColor(Color.parseColor("#161d4a"));
                        } else {
                            cellView.getDayOfMonthTextView().setTextColor(Color.parseColor("#AEAEAE"));
                        }
                    }
