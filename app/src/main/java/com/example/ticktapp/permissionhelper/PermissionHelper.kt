package com.example.ticktapp.permissionhelper
...
class PermissionHelper {
    ...
    fun setPermissionResult(
        ...
        when (isAllPermissionGranted) {
            ...
            PERMISION_RATIONAL -> {
                showDialog(
                    ApplicationClass.applicationContext().resources?.getString(R.string.permission_from_device)!!,
                    requestCode
                )
            }
        }
                ...
                if (fragment != null) {
                    fragment!!.startActivityForResult(
                        Intent(
                            ...
                            Uri.parse("package:" + "com.example.ticktapp")
