...
import com.example.ticktapp.databinding.RowitemJobsBinding
import com.app.core.model.jobmodel.JobModel

class JobsAdapter(private val listener: JobAdapterListener, var jobList: ArrayList<JobModel>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): RecyclerView.ViewHolder {
        return ViewHolderAnswer(
            DataBindingUtil.inflate(
                LayoutInflater.from(parent.context),
                R.layout.rowitem_jobs, parent, false
            )
        )
    }
    ...
    inner class ViewHolderAnswer(val binding: RowitemJobsBinding) :
