...
import com.example.ticktapp.databinding.RowitemRecommendedTradieBinding
import com.google.android.flexbox.AlignItems
import com.google.android.flexbox.FlexDirection
import com.google.android.flexbox.FlexWrap
import com.google.android.flexbox.FlexboxLayoutManager

class HomeTradieHorizontalAdapter(
    var tradeHome: ArrayList<TradeHome>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): RecyclerView.ViewHolder {
        return ViewHolderAnswer(
            DataBindingUtil.inflate(
                ...
                R.layout.rowitem_recommended_tradie, parent, false
            )
        )
    }
    ...
    inner class ViewHolderAnswer(val binding: RowitemRecommendedTradieBinding) :
        ...
        fun bind(tradeHome: TradeHome) {
            ...
            binding.tvCategoryTop.text = tradeHome.tradeData!![0].tradeName
