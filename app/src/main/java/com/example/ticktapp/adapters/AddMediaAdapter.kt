...
class AddMediaAdapter(var photos: ArrayList<Photos>, val listener: View.OnClickListener) :
    ...
    fun isExits(link: String): Boolean {
        photos.forEach {
            if (it.link == link) {
                return true
            }
