...
import com.example.ticktapp.mvvm.view.builder.BuilderMessageFragment
...
class MessagesAdapter(
    ...
    lateinit var builderMessageFragment: BuilderMessageFragment
    ...
    fun setContext(builderMessageFragment: BuilderMessageFragment) {
        this.builderMessageFragment = builderMessageFragment
    }
    ...
    inner class RecordFilter : Filter() {
        ...
        override fun publishResults(constraint: CharSequence, results: FilterResults) {
            ...
            builderMessageFragment.manageRecyclerViewVisibility(messageList)
