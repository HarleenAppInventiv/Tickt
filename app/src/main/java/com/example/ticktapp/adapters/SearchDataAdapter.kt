...
import com.example.ticktapp.databinding.RowSearchSuggestionBinding
import com.app.core.model.jobmodel.JobModel

class SearchDataAdapter(var onClickListener: View.OnClickListener, var jobList: ArrayList<JobModel>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): RecyclerView.ViewHolder {
        return ViewHolderAnswer(
            DataBindingUtil.inflate(
                LayoutInflater.from(parent.context),
                R.layout.row_search_suggestion, parent, false
            )
        )
    }
    ...
    inner class ViewHolderAnswer(val binding: RowSearchSuggestionBinding) :
