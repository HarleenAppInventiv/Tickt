...
import com.example.ticktapp.databinding.ActivityLoungeDisputeBuilderBinding
...
class LodgeDisputeBuilderActivity : BaseActivity(), OnClickListener,
    ...
    private lateinit var mBinding: ActivityLoungeDisputeBuilderBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_lounge_dispute_builder)
        setObservers()
        setStatusBarColor()
    ...
    private fun setupView() {
        ...
        ViewCompat.setNestedScrollingEnabled(mBinding.rvCancel, false)
    ...
    override fun onResponseSuccess(statusCode: Int, apiCode: Int, msg: String?) {
        when (apiCode) {
            ApiCodes.LODGE_DISPUTE -> {
                startActivity(Intent(this, LodgeDisputedJobActivity::class.java))
            }
            ApiCodes.UPLOAD_FILE -> {
                mViewModelImage.imageUploadResponse.url.let {
                    ...
                    mViewModel.lodgeDisputeBuidler(mObject)
                }
            }
        }
