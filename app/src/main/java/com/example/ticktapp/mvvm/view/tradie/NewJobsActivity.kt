...
import com.example.ticktapp.mvvm.viewmodel.NewJobRequestViewModel
...
class NewJobsActivity : BaseActivity(), SwipeRefreshLayout.OnRefreshListener,
    ...
    private val mViewModel by lazy { ViewModelProvider(this).get(NewJobRequestViewModel::class.java) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel.getNewJobRequestList(pageNumber, true)
    }
    ...
    override fun onLoadMore(page: Int, totalItemsCount: Int, view: RecyclerView?) {
        pageNumber = page + 1
        mViewModel.getNewJobRequestList(pageNumber, false)
    }
