...
class VerifyNumberActivity : BaseActivity(), View.OnClickListener,
    ...
    private fun initView() {
        ...
        mBinding.rlToolbar.tvTitle.setText(getString(R.string.verify_your_number))
    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            mBinding.tvResendCode.id -> {
                phoneno?.let { mViewModel.checkMobileNumber(it) }
            }
        }
    }
    ...
    override fun onResponseSuccess(statusCode: Int, apiCode: Int, msg: String?) {
        when (apiCode) {
            ApiCodes.VERIFY_OTP -> {
                ...
                if ((PreferenceManager.getInt(PreferenceManager.SOCIAL_TYPE) == SocialType.GOOGLE ||
                            PreferenceManager.getInt(PreferenceManager.SOCIAL_TYPE) == SocialType.LINKEDIN)
