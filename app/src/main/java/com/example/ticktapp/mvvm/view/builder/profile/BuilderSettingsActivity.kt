...
import com.example.ticktapp.databinding.ActivityBuilderSettingBinding
import com.example.ticktapp.mvvm.viewmodel.SettingViewModel

class BuilderSettingsActivity : BaseActivity() {
    private lateinit var mBinding: ActivityBuilderSettingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = setContentView(this, R.layout.activity_builder_setting)
        setStatusBarColor()
