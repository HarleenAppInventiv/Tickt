...
class RatedTradieActivity : BaseActivity() {
    ...
    private fun screenSelect() {
        ...
        mBinding.tvSubheading.setText(getString(R.string.rated_msg))
        mBinding.tvYellowBtn.setText(getString(R.string.ok))
        mBinding.rlBackground.background =
            ContextCompat.getDrawable(this, R.drawable.ic_bg_rate_review)
    }
