 ...
 * @param context
 */
class CameraVideBottomSheet(
    context: Context,
    var mCameraDialogCallBack: CameraDialogCallBack,
    var hideVideoOption:Boolean=false
) :
    ...
    private fun setListeners() {
        ...
        mBinding.tvDropBox.setOnClickListener(this)
        if (hideVideoOption)
        {
            mBinding.tvFiles.visibility=View.GONE
        }
    }
    ...
    override fun onClick(v: View?) {
        ...
        when (v) {
            ...
            mBinding.tvDropBox -> mCameraDialogCallBack.onDropBoxClicked()
        }
    }
