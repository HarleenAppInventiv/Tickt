...
import com.example.ticktapp.databinding.BottomSheetGalleryCameraBinding
...
class GalleryCameraBottomSheet(
    ...
    lateinit var mBinding: BottomSheetGalleryCameraBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.bottom_sheet_gallery_camera,
            null,
            false
        )
